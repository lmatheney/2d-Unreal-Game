...
static_assert(std::is_polymorphic<FConvertSpeechSequenceNodeToSpeechNodes_DialogueGraphSchemaAction>() == std::is_polymorphic<FEdGraphSchemaAction>(), "USTRUCT FConvertSpeechSequenceNodeToSpeechNodes_DialogueGraphSchemaAction cannot be polymorphic unless super FEdGraphSchemaAction is polymorphic");
...
static struct FScriptStruct_DlgSystemEditor_StaticRegisterNativesFConvertSpeechSequenceNodeToSpeechNodes_DialogueGraphSchemaAction
{
	...
	{
		UScriptStruct::DeferCppStructOps<FConvertSpeechSequenceNodeToSpeechNodes_DialogueGraphSchemaAction>(FName(TEXT("ConvertSpeechSequenceNodeToSpeechNodes_DialogueGraphSchemaAction")));
	}
