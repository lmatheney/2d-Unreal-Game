...
static_assert(std::is_polymorphic<FNewComment_DialogueGraphSchemaAction>() == std::is_polymorphic<FEdGraphSchemaAction>(), "USTRUCT FNewComment_DialogueGraphSchemaAction cannot be polymorphic unless super FEdGraphSchemaAction is polymorphic");
...
static struct FScriptStruct_DlgSystemEditor_StaticRegisterNativesFNewComment_DialogueGraphSchemaAction
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNewComment_DialogueGraphSchemaAction>(FName(TEXT("NewComment_DialogueGraphSchemaAction")));
	}
