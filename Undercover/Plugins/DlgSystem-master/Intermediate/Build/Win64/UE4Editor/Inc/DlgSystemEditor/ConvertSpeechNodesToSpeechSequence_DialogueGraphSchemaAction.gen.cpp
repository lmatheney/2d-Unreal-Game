...
static_assert(std::is_polymorphic<FConvertSpeechNodesToSpeechSequence_DialogueGraphSchemaAction>() == std::is_polymorphic<FEdGraphSchemaAction>(), "USTRUCT FConvertSpeechNodesToSpeechSequence_DialogueGraphSchemaAction cannot be polymorphic unless super FEdGraphSchemaAction is polymorphic");
...
static struct FScriptStruct_DlgSystemEditor_StaticRegisterNativesFConvertSpeechNodesToSpeechSequence_DialogueGraphSchemaAction
{
	...
	{
		UScriptStruct::DeferCppStructOps<FConvertSpeechNodesToSpeechSequence_DialogueGraphSchemaAction>(FName(TEXT("ConvertSpeechNodesToSpeechSequence_DialogueGraphSchemaAction")));
	}
