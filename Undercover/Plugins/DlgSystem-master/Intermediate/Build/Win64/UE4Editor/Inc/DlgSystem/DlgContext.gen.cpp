...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_DlgSystem_EDlgValidateStatus_Hash() { return 3515366932U; }
...
static struct FScriptStruct_DlgSystem_StaticRegisterNativesFDlgEdgeData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDlgEdgeData>(FName(TEXT("DlgEdgeData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDlgEdgeData_Hash() { return 3372639165U; }
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DlgContext_eventChooseOptionFromAll_Parms, Index), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(DlgContext_eventChooseOptionFromAll_Parms), &Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::NewProp_Index,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::Function_MetaDataParams[] = {
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDlgContext, nullptr, "ChooseOptionFromAll", nullptr, nullptr, sizeof(DlgContext_eventChooseOptionFromAll_Parms), Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_Participant;
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::NewProp_Participant_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::NewProp_Participant = { "Participant", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DlgContext_eventGetParticipantFromName_Parms, Participant), Z_Construct_UScriptStruct_FDlgParticipantName, METADATA_PARAMS(Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::NewProp_Participant_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::NewProp_Participant_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DlgContext_eventGetParticipantFromName_Parms, ReturnValue), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::NewProp_Participant,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::Function_MetaDataParams[] = {
		{ "Category", "Dialogue|Data" },
		{ "ModuleRelativePath", "Public/DlgContext.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDlgContext, nullptr, "GetParticipantFromName", nullptr, nullptr, sizeof(DlgContext_eventGetParticipantFromName_Parms), Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDlgContext_GetParticipantFromName()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UDlgContext_GetParticipantFromName_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_NodeIndex = { "NodeIndex", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DlgContext_eventIsNodeVisited_Parms, NodeIndex), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_NodeGUID_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_NodeGUID = { "NodeGUID", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DlgContext_eventIsNodeVisited_Parms, NodeGUID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_NodeGUID_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_NodeGUID_MetaData)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_bLocalHistory = { "bLocalHistory", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(DlgContext_eventIsNodeVisited_Parms), &Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_bLocalHistory_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(DlgContext_eventIsNodeVisited_Parms), &Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_NodeIndex,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_NodeGUID,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_bLocalHistory,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::Function_MetaDataParams[] = {
		{ "Category", "Dialogue|Context|History" },
		{ "ModuleRelativePath", "Public/DlgContext.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDlgContext, nullptr, "IsNodeVisited", nullptr, nullptr, sizeof(DlgContext_eventIsNodeVisited_Parms), Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54C20400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDlgContext_IsNodeVisited()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UDlgContext_IsNodeVisited_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDlgContext_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDlgContext_ChooseChild, "ChooseChild" }, // 1474839727
		{ &Z_Construct_UFunction_UDlgContext_ChooseOption, "ChooseOption" }, // 3941191853
		{ &Z_Construct_UFunction_UDlgContext_ChooseOptionFromAll, "ChooseOptionFromAll" }, // 3333735794
		{ &Z_Construct_UFunction_UDlgContext_ChooseSpeechSequenceOptionFromReplicated, "ChooseSpeechSequenceOptionFromReplicated" }, // 533253137
		...
		{ &Z_Construct_UFunction_UDlgContext_GetAllOptionsArray, "GetAllOptionsArray" }, // 2724726129
		...
		{ &Z_Construct_UFunction_UDlgContext_GetMutableNodeFromGUID, "GetMutableNodeFromGUID" }, // 2734440687
		{ &Z_Construct_UFunction_UDlgContext_GetMutableNodeFromIndex, "GetMutableNodeFromIndex" }, // 2927989876
		{ &Z_Construct_UFunction_UDlgContext_GetMutableParticipant, "GetMutableParticipant" }, // 823288445
		{ &Z_Construct_UFunction_UDlgContext_GetNodeGUIDForIndex, "GetNodeGUIDForIndex" }, // 2814593988
		{ &Z_Construct_UFunction_UDlgContext_GetNodeIndexForGUID, "GetNodeIndexForGUID" }, // 2369443332
		{ &Z_Construct_UFunction_UDlgContext_GetOption, "GetOption" }, // 2120108968
		{ &Z_Construct_UFunction_UDlgContext_GetOptionEnterConditions, "GetOptionEnterConditions" }, // 852838063
		{ &Z_Construct_UFunction_UDlgContext_GetOptionFromAll, "GetOptionFromAll" }, // 3488064504
		{ &Z_Construct_UFunction_UDlgContext_GetOptionsArray, "GetOptionsArray" }, // 2532586435
		{ &Z_Construct_UFunction_UDlgContext_GetOptionsNum, "GetOptionsNum" }, // 3136606887
		{ &Z_Construct_UFunction_UDlgContext_GetOptionSpeakerState, "GetOptionSpeakerState" }, // 569293162
		{ &Z_Construct_UFunction_UDlgContext_GetOptionSpeakerStateFromAll, "GetOptionSpeakerStateFromAll" }, // 2446761408
		{ &Z_Construct_UFunction_UDlgContext_GetOptionText, "GetOptionText" }, // 2648032398
		{ &Z_Construct_UFunction_UDlgContext_GetOptionTextFromAll, "GetOptionTextFromAll" }, // 2554063528
		{ &Z_Construct_UFunction_UDlgContext_GetParticipantFromName, "GetParticipantFromName" }, // 376680512
		{ &Z_Construct_UFunction_UDlgContext_GetParticipants, "GetParticipants" }, // 3786397905
		{ &Z_Construct_UFunction_UDlgContext_GetParticipantsMap, "GetParticipantsMap" }, // 936496789
		{ &Z_Construct_UFunction_UDlgContext_GetVisitedNodeGUIDs, "GetVisitedNodeGUIDs" }, // 1244145722
		{ &Z_Construct_UFunction_UDlgContext_GetVisitedNodeIndices, "GetVisitedNodeIndices" }, // 2649653564
		{ &Z_Construct_UFunction_UDlgContext_HasDialogueEnded, "HasDialogueEnded" }, // 131136885
		{ &Z_Construct_UFunction_UDlgContext_IsNodeVisited, "IsNodeVisited" }, // 2293440849
		{ &Z_Construct_UFunction_UDlgContext_IsOptionConnectedToEndNode, "IsOptionConnectedToEndNode" }, // 1701083334
		{ &Z_Construct_UFunction_UDlgContext_IsOptionConnectedToVisitedNode, "IsOptionConnectedToVisitedNode" }, // 3177763808
		{ &Z_Construct_UFunction_UDlgContext_IsOptionSatisfied, "IsOptionSatisfied" }, // 3988718645
		{ &Z_Construct_UFunction_UDlgContext_IsValidAllOptionIndex, "IsValidAllOptionIndex" }, // 2248652301
		{ &Z_Construct_UFunction_UDlgContext_IsValidNodeGUID, "IsValidNodeGUID" }, // 2057716879
		{ &Z_Construct_UFunction_UDlgContext_IsValidNodeIndex, "IsValidNodeIndex" }, // 33855790
		{ &Z_Construct_UFunction_UDlgContext_IsValidOptionIndex, "IsValidOptionIndex" }, // 2441453592
		...
		{ &Z_Construct_UFunction_UDlgContext_WasNodeGUIDVisitedInThisContext, "WasNodeGUIDVisitedInThisContext" }, // 29521983
		{ &Z_Construct_UFunction_UDlgContext_WasNodeIndexVisitedInThisContext, "WasNodeIndexVisitedInThisContext" }, // 1305524059
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UDlgContext, 3166565458);
