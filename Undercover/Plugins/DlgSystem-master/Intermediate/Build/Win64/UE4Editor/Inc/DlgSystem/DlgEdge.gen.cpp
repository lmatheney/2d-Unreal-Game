...
static struct FScriptStruct_DlgSystem_StaticRegisterNativesFDlgEdge
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDlgEdge>(FName(TEXT("DlgEdge")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_EdgeData_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_EdgeData;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDlgEdge_Statics::NewProp_EdgeData_MetaData[] = {
		{ "Category", "DialogueEdge" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/DlgEdge.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FDlgEdge_Statics::NewProp_EdgeData = { "EdgeData", nullptr, (EPropertyFlags)0x001200000008001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDlgEdge, EdgeData), Z_Construct_UClass_UDlgNodeData_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FDlgEdge_Statics::NewProp_EdgeData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDlgEdge_Statics::NewProp_EdgeData_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FDlgEdge_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FDlgEdge_Statics::NewProp_EdgeData,
	...
	uint32 Get_Z_Construct_UScriptStruct_FDlgEdge_Hash() { return 1141878605U; }
