...
// End Cross Module References
	static UEnum* EDlgEntryRestriction_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_DlgSystem_EDlgEntryRestriction, Z_Construct_UPackage__Script_DlgSystem(), TEXT("EDlgEntryRestriction"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EDlgEntryRestriction(EDlgEntryRestriction_StaticEnum, TEXT("/Script/DlgSystem"), TEXT("EDlgEntryRestriction"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_DlgSystem_EDlgEntryRestriction_Hash() { return 1382620744U; }
	UEnum* Z_Construct_UEnum_DlgSystem_EDlgEntryRestriction()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_DlgSystem();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EDlgEntryRestriction"), 0, Get_Z_Construct_UEnum_DlgSystem_EDlgEntryRestriction_Hash(), false);
#else
	...
	struct Z_Construct_UClass_UDlgNode_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_EnterRestriction_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_EnterRestriction_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_EnterRestriction;
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDlgNode_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UDlgNode_GetNodeChildAt, "GetNodeChildAt" }, // 3666801259
		{ &Z_Construct_UFunction_UDlgNode_GetNodeChildren, "GetNodeChildren" }, // 2333873581
		{ &Z_Construct_UFunction_UDlgNode_GetNodeData, "GetNodeData" }, // 1279271441
		{ &Z_Construct_UFunction_UDlgNode_GetNodeEnterConditions, "GetNodeEnterConditions" }, // 1149176454
		{ &Z_Construct_UFunction_UDlgNode_GetNodeEnterEvents, "GetNodeEnterEvents" }, // 2480044141
		...
		{ &Z_Construct_UFunction_UDlgNode_GetTextArguments, "GetTextArguments" }, // 2617262832
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UDlgNode_Statics::NewProp_EnterRestriction_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDlgNode_Statics::NewProp_EnterRestriction_MetaData[] = {
		{ "Category", "Dialogue|Node" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UDlgNode_Statics::NewProp_EnterRestriction = { "EnterRestriction", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDlgNode, EnterRestriction), Z_Construct_UEnum_DlgSystem_EDlgEntryRestriction, METADATA_PARAMS(Z_Construct_UClass_UDlgNode_Statics::NewProp_EnterRestriction_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDlgNode_Statics::NewProp_EnterRestriction_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDlgNode_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDlgNode_Statics::NewProp_EnterRestriction_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDlgNode_Statics::NewProp_EnterRestriction,
	...
	IMPLEMENT_CLASS(UDlgNode, 1581142081);
