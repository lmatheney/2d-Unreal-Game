...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bUseBorderHighlight_MetaData[];
#endif
		static void NewProp_bUseBorderHighlight_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bUseBorderHighlight;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDialogueGraphNode_Statics::NewProp_bUseBorderHighlight_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDialogueGraphNode_Statics::NewProp_bUseBorderHighlight = { "bUseBorderHighlight", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UDialogueGraphNode), &Z_Construct_UClass_UDialogueGraphNode_Statics::NewProp_bUseBorderHighlight_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDialogueGraphNode_Statics::NewProp_bUseBorderHighlight_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueGraphNode_Statics::NewProp_bUseBorderHighlight_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDialogueGraphNode_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDialogueGraphNode_Statics::NewProp_bUseBorderHighlight,
	};
	...
	IMPLEMENT_CLASS(UDialogueGraphNode, 1048859227);
